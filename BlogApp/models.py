...
class User(AbstractUser):
    ...
    profile_picture_path = models.CharField(max_length=255, null=True, blank=True, default="/media/profile_images/default.png")
...
class BlogLike(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['user', 'blog_post'], name='unique_blog_like')
        ]